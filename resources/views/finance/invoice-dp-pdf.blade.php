...
<div class="header">
    <div class="title">INVOICE DP</div>
...
<table class="summary">
    ...
    <tr>
        <td class="right"><strong>DP Dibayarkan</strong></td>
        <td class="right paid">Rp {{ number_format($dpAmount, 0, ',', '.') }}</td>
    </tr>
    <tr>
        <td class="right"><strong>Sisa Tagihan</strong></td>
        <td class="right remaining">Rp {{ number_format($remainingAmount, 0, ',', '.') }}</td>
    </tr>
</table>
...
<p>
    Invoice ini merupakan bukti pembayaran DP untuk Order #{{ $order->id }}.
</p>
